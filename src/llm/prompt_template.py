class ReportPromptTemplate:
    ...
    GROUNDING_RULES = (
        ...
        "- The application, not the LLM, is responsible for rendering authoritative numeric indicator values.\n"
        "- Do not reproduce percentages, monetary amounts, ratios, counts or other numeric indicator values in the narrative.\n"
        "- Describe quantitative findings qualitatively, for example 'revenue growth deteriorated materially' or 'leverage remains elevated'.\n"
    ...
    NARRATIVE_GUIDANCE = (
        ...
        "- Do not add headings, labels, numbering or category names to the generated paragraphs; the application adds the fixed assessment-area headings.\n"
    ...
    OUTPUT_CONTRACT = (
        ...
        "Do not include numeric values in the narrative; authoritative values are rendered separately from deterministic evidence.\n"
