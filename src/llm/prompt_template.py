class ReportPromptTemplate:
    ...
    GROUNDING_RULES = (
        ...
        "- Use material numerical indicators when they strengthen the narrative, but do not force "
        "every supplied value to be repeated.\n"
        "- When a numerical indicator is used, preserve its supplied value and unit without changing "
        "its meaning. Equivalent presentation formatting is acceptable.\n"
    ...
    NARRATIVE_GUIDANCE = (
        ...
        "- Avoid unnecessary repetition of indicators or numerical values.\n"
    ...
    OUTPUT_CONTRACT = (
        ...
        "- Do not repeat the same finding or indicator value unnecessarily.\n"
