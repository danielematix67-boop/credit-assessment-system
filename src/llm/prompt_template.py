class ReportPromptTemplate:
    ...
    GROUNDING_RULES = (
        ...
        "- Do not infer sales volume, pricing, demand, costs, liquidity, cash flow, "
        "debt service capacity or financial stability unless explicitly provided.\n"
        ...
        "'likely reflects' or 'suggests' unless the supplied finding itself explicitly "
    ...
    NARRATIVE_GUIDANCE = (
        ...
        "- Prefer precise credit-analysis wording: state the metric, its direction or level, "
        "and the directly supported credit implication once.\n"
        ...
        "- Narrative length should scale with the number of material categories and findings: "
        "cover all material findings, but do not pad the text.\n"
    ...
    OUTPUT_CONTRACT = (
        ...
        "- Each material indicator must appear exactly once.\n"
