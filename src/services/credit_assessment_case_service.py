...
class CreditAssessmentCaseService:
    ...
    def __init__(
        ...
        debt_sustainability_assessment_service: (
            DebtSustainabilityAssessmentService | None
        ) = None,
        customer_profile_assessment_service: (
            CustomerProfileAssessmentService | None
        ) = None,
        ...
        self.debt_sustainability_assessment_service = (
            debt_sustainability_assessment_service
            or DebtSustainabilityAssessmentService()
        )
    ...
    def assess(
        ...
        debt_sustainability_section = (
            self.debt_sustainability_assessment_service.assess(
