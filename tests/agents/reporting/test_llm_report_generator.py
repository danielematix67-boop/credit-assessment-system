...
def test_discursive_narrative_preserves_all_findings_and_indicators() -> None:
    ...
    response = (
        "Revenue growth declined to -20.0%, indicating a deterioration in the company's top-line "
        "performance.\n\n"
        "EBITDA is negative, with a reported value of €-120,000, indicating negative operating "
        "profitability. The interest coverage ratio is -0.2x, indicating that EBITDA provides "
        "insufficient coverage of interest expense. EBITDA margin is -8.0%.\n\n"
        "NFP to EBITDA stands at 7.0x, above the acceptable level, indicating elevated leverage "
