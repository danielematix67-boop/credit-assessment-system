...
def test_assessment_service_generates_assessment():
    ...
    assert assessment.comments[1].text == "EBITDA margin is below acceptable threshold."

    assert assessment.comments[2].rule_id == "R004"
    assert assessment.comments[2].text == "Leverage is above acceptable threshold."

    assert assessment.comments[3].rule_id == "R005"
    assert assessment.comments[3].text == "Interest coverage is below acceptable threshold."
