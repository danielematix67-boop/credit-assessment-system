...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            RuleSeverity.MEDIUM,
            "LOWER_IS_WORSE",
            ((-0.10, RuleSeverity.MEDIUM), (-0.30, RuleSeverity.HIGH)),
        ),
        ("R002", 0.0, RuleSeverity.HIGH, "LOWER_IS_WORSE", ()),
        (
            "R003",
            0.0,
            RuleSeverity.MEDIUM,
            "LOWER_IS_WORSE",
            ((0.0, RuleSeverity.MEDIUM), (-0.10, RuleSeverity.HIGH)),
        ),
        (
            "R004",
            5.0,
            RuleSeverity.MEDIUM,
            "HIGHER_IS_WORSE",
            ((5.0, RuleSeverity.MEDIUM), (7.0, RuleSeverity.HIGH)),
        ),
        (
            "R005",
            0.60,
            RuleSeverity.MEDIUM,
            "HIGHER_IS_WORSE",
            ((0.60, RuleSeverity.MEDIUM), (1.00, RuleSeverity.HIGH)),
        ),
        (
            "R006",
            0.30,
            RuleSeverity.MEDIUM,
            "HIGHER_IS_WORSE",
            ((0.30, RuleSeverity.MEDIUM), (0.50, RuleSeverity.HIGH)),
        ),
        (
            "R007",
            2.0,
            RuleSeverity.MEDIUM,
            "LOWER_IS_WORSE",
            ((2.0, RuleSeverity.MEDIUM), (1.0, RuleSeverity.HIGH)),
        ),
    ],
)
...
def test_rule_configuration_thresholds_have_valid_severities(rule_configs):
