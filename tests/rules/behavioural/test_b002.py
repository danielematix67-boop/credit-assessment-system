...
def make_rule() -> ProlongedOverdraftRule:
    return ProlongedOverdraftRule(RuleConfig(rule_id="B002", rule_name="Prolonged Overdraft", category="overdraft", threshold=10.0, severity=RuleSeverity.MEDIUM, severity_direction="HIGHER_IS_WORSE", input_field="overdraft_days", trigger_operator="GT"))
