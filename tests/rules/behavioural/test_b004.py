...
def make_rule() -> ExposureGrowthRule:
    return ExposureGrowthRule(RuleConfig(rule_id="B004", rule_name="Exposure Growth", category="exposure", threshold=0.25, severity=RuleSeverity.MEDIUM, severity_direction="HIGHER_IS_WORSE", input_field="exposure_growth", trigger_operator="GT"))
